...
function Form() {
    return (
        <div className="block w-[50%] rounded-lg bg-white my-10 p-14 border-[#FF8AAE] border-4  shadow-[0_2px_15px_-3px_rgba(0,0,0,0.07),0_10px_20px_-2px_rgba(0,0,0,0.04)] dark:bg-neutral-700">
                <form>
                {/* <!--Name input--> */}
                <TEInput
                    type="text"
