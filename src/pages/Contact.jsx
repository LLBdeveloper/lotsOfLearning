    ...
    <>
      {
        loading ? (
          ...
          <div className="p-2 flex flex-col justify-center items-center my-20">
            ...
            <h2 className="my-5 xs:text-lg sm:text-xl lg:text-2xl text-center xs:w-[90%] sm:w-[60%]">Complete the form below and join our community of teachers passionate about teaching English to the little ones. We hope to meet you soon!</h2>
            <Form/>
          </div>
        )
      }
