...
function Courses() {
  return (
    <div className="w-full flex flex-col justify-center items-center my-20">
      ...
      <h2 className=" my-16 xs:text-xl sm:text-2xl lg:text-4xl font-bold">{`Beginner's Guide for Kindergarten Teachers`}</h2>
      <div className="mx-10 w-[70%] xs:text-lg sm:text-xl lg:text-2xl  flex flex-col justify-center items-center text-center">      
        <div className="flex justify-center items-center gap-5 my-5">
          ...
          <img src="https://firebasestorage.googleapis.com/v0/b/lotsoflearning-54445.appspot.com/o/Como-conseguir-empleo-en-colegios-de-Educacion-Especial-38.jpg?alt=media&token=3ce060c1-89c8-40c1-a5cd-e4c963e4e6d2" className="w-[50%] rounded-xl" alt="" />
        </div>
        
        <div className="flex justify-center items-center gap-5 my-5">
          <img src="https://firebasestorage.googleapis.com/v0/b/lotsoflearning-54445.appspot.com/o/profesor-y-estudiante-978x652.jpg?alt=media&token=30599c46-038b-4406-a4bd-211a8296714e" className="w-[50%] rounded-xl" alt="" />
